...
namespace DecisionMaker
{
    internal static class HelpSectConstants
    {
        ...
        private const string GITHUB_LINK = @"https://github.com/Xymdyx/DecisionMaker";
        ...
        internal static readonly string[] mainTopics = { "Overview", "Navigation", "GeneratedFiles", "GitHub Link" };
...
There may be as many as 0 to N 'Decision Category' files.
...
Please remember:
NO FILES/DIRECTORIES GENERATED BY THIS PROGRAM SHOULD BE DELETED WHILE THE PROGRAM RUNS.
NOR FILES BE ADDED TO GENERATED DIRECTORIES WHILE THE PROGRAM RUNS.
FINALLY NO SHOULD ANY FILES/DIRECTORIES BE MANIPULATED WHILE THE PROGRAM RUNS...";

        internal const string REPO_INFO = @"
If you need to find the place you got this from again, here is the Github link:" + $"\n{GITHUB_LINK}\n"  +
@"Bug reports are appreicated if they're thorough and describe how to recreate the bug.
Please do this via the Issues section on the GitHub link.
I will probably only add new features if I feel inspired to and have tested them thoroughly.

Thanks for using this program and please don't take what it says for serious decisions!";
    }
}